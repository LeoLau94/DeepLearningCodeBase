...
def measure_model(original_model, pruned_model, input_size):
    original_model.cpu()
    pruned_model.cpu()

    print('Model before pruning:')
    original_model_params = measure_layer_param(original_model)
    original_model_flops = measure_layer_flops(original_model, input_size)

    print('Model after pruning:')
    pruned_model_params = measure_layer_param(pruned_model)
    pruned_model_flops = measure_layer_flops(pruned_model, input_size)
