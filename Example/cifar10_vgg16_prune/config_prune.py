...
PRUNE_RATIO = 0.6
PARAMS = '/data/leolau/checkpoints/CIFAR10/VGG16(LASSO)/Sep20_04-45-59/best_performance_model_params.pkl'
...
#function config
preprocess_method = preprocessVGG16
transfer_method = transferVGG16
