...
WEIGHT_DECAY = 0
LOSS_RATIO = 0.9
#STUDENT_PARAMS = '/data/leolau/checkpoints/CIFAR10/VGG16(Pruned)/Sep29_07-46-52/pruned_model.pkl'
STUDENT_PARAMS = '/data/leolau/checkpoints/CIFAR10/VGG16(Pruned)/Sep29_09-01-29/pruned_model.pkl'
TEACHER_PARAMS = '/data/leolau/checkpoints/CIFAR10/VGG16/Sep20_04-45-41/best_performance_model_params.pkl'

# initialize a model
loadPKL = torch.load(STUDENT_PARAMS)
model = vgg_diy(cfg=loadPKL['cfg'], num_classes=NUM_CLASSES)
